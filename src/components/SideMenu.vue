...
<template>
    <div class="col-2 logoDiv d-flex align-items-center justify-content-center">
        <span v-if="screenType == 'mobile'">
            <a v-on:click="toggleMobileMenu"><img src="../assets/sun_full_blue.png" class="logo me-2" />TradeNote</a>
        </span>
    ...
    <div id="step2">
        <div class="sideMenuDiv">
            <div class="sideMenuDivContent">
                ...
                <a id="step5" v-bind:class="[pageId === 'daily' ? 'activeNavCss' : '', 'nav-link', 'mb-2']"
                    href="/daily">
        ...
        <div class="sideMenuDiv">
            <div class="sideMenuDivContent">
                ...
                <a id="step6" v-bind:class="[pageId === 'diary' ? 'activeNavCss' : '', 'nav-link', 'mb-2']"
                    href="/diary">
