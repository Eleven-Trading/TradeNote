const addTradesMixin = {
    methods: {
        ...
        videoInput(event, param) { //param is td/trad unix data
            ...
            this.videos[param].fileExtension = fileName.slice((fileName.lastIndexOf(".") - 1 >>> 0) + 2)
        ...
        /* ---- 3: CREATE TIME AND NAME (param1 is inpute date and time, param2 is td/trade unix date)---- */
        videoStartTime(param1, param2) {
            ...
            this.videos[param2].startTimeUnix = startTimeUnix
                //this.videos[param2].name = Parse.User.current().id + "-" + startTimeUnix + "-" + dayjs().unix() + "." + this.videos[param2].fileExtension
            this.videos[param2].name = Parse.User.current().id + "-" + startTimeUnix + "." + this.videos[param2].fileExtension
